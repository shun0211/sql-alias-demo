...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { student_id: @homework.student_id, teacher_id: @homework.teacher_id, title: @homework.title } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { student_id: @homework.student_id, teacher_id: @homework.teacher_id, title: @homework.title } }
